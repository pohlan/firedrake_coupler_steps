...
# # print(df_sm)
# T_L_smooth = df_sm.t_u

# # get array of how many days each point is away from 2018-01-01
# i_0 = np.argmin(abs(df_sm.index - np.datetime64('2018-01-01')))
# time_np = np.array(df_sm.index)
# dT_days = (time_np - time_np[i_0]) / np.timedelta64(1, 'D')
# # print(dT_days)

# save as csv
data_dir = 'Greenland_data/'
# dff = pd.DataFrame({'dT_days':dT_days, 'T_L_smooth':df_sm.t_u, 'z_L': df_sm.alt})
...
# r = gu.Raster("NETCDF:Greenland_data/forcing/MAR/MARv3.14.3-10km-daily-ERA5-2017.nc:water_input_rate")
# delta = r.res[0]*5
# r.crop([x_L-delta, y_L-delta, x_L+delta, y_L+delta], inplace=True)
# year_0  = 2016 - 1940 # starts in 1940
# n_years = 5
