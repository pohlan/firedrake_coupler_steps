...
chk_file = results_dir + f"initial_fields_russel_hydro_sig{sig}.h5"
csv_file = results_dir + f"initial_S_russel_hydro_sig{sig}.csv"
...
# save end states for initialization
